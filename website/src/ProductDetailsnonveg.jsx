...
import muttonImg from "./assets/muttonbriyani.jpeg";
import fishImg from "./assets/fishbriyani.jpeg";
import crabImg from "./assets/crabbriyani.jpeg";
import prawnImg from "./assets/prawnbriyani.jpeg";

function ProductDetailsnonveg() {
  ...
  const relatedItems = [
    { name: "Chicken Biryani", image: chickenImg, price: 660 },
    { name: "Mutton Biryani", image: muttonImg, price: 900, discount: 20 },
    { name: "Fish Biryani", image: fishImg, price: 850 },
    { name: "Prawn Biryani", image: prawnImg, price: 880, discount: 10 },
    { name: "Crab Biryani", image: crabImg, price: 660 },
  ...
  return (
    <div className="page-container-full menu-bg">
      ...
      {/* HEADING */}
      <h1 className="menu-heading-center">NON-VEG MENU</h1>
        ...
        {relatedItems
          ...
          .map((item, index) => (
            ...
            >
              ...
              <p style={{ fontSize: "18px", fontWeight: "700", color: "#b30000", marginBottom: "12px" }}>
                ₹{item.price}
              </p>
...
export default ProductDetailsnonveg;