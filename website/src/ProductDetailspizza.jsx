...
import vegpizzaImg from "./assets/vegpizza.jpeg";
import chickenpizzaImg from "./assets/chickenpizza.jpeg";
import bbqpizzaImg from "./assets/bbqchickenpizza.jpeg";
import spicypizzaImg from "./assets/spicychickenpizza.jpeg";
import tandooriImg from "./assets/tandooripizza.jpeg";

function ProductDetailspizza() {
  const { setCart } = useContext(CartContext);
  const [activeCard, setActiveCard] = useState(null);
  const [selectedQty, setSelectedQty] = useState({});
  const [search, setSearch] = useState("");
  const relatedItems = [
    { name: "Veg Pizza", image: vegpizzaImg, price: 800 },
    { name: "Chicken Pizza", image: chickenpizzaImg, price: 950 },
    { name: "BBQ Pizza", image: bbqpizzaImg, price: 670 },
    { name: "Spicy Chicken Pizza", image: spicypizzaImg, price: 800 },
    { name: "Tandoori Pizza", image: tandooriImg, price: 800 },
  ];
  ...
  export default ProductDetailspizza;